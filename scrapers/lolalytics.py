...
# Lolalytics uses season-based numbering: season 15 = 2025, season 16 = 2026.
# Riot switched to year-based numbering in 2025 (25.x), so Lola 15.x = Riot 25.x.
# The API only retains data for recent patches (~1 season back), so older data is unavailable.
LOLALYTICS_PATCHES = []
